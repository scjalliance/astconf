...
// The base configuration should leave Auth, AORs and Mailboxes empty;
// values there would be combined with the per-device values.
...
// software phone.
//
// The values in the base configuration will be merged into each auth
// that is returned.
func Auths(data *astorg.DataSet, base pjsip.Auth) []pjsip.Auth {
	...
	for _, phone := range data.Phones {
		...
		m.Add(pjsip.MergeAuths(base, auth))
	}
