// Package astorg provides a set of simplified domain entities for an
// organization that needs to provide configuration to one or more
// asterisk phone servers.
//
